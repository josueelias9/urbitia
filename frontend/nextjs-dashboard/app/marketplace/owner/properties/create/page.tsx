...
export default function CreatePropertyPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const requiredFields = ['title', 'description', 'price', 'bedrooms', 'bathrooms', 'area', 'street', 'city', 'country']
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center">
                            <Link href="/marketplace/owner/dashboard" className="flex items-center space-x-2">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white rounded-lg shadow-sm p-8">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Fill in the details to list your property on the marketplace</p>
                    </div>
