        ...
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto py-8 px-4">
                ...
                <div className="mb-8 flex justify-between items-center">
                    ...
                    <Link href="/marketplace/owner/properties/create" className="bg-blue-600 text-white px-4 py-2 rounded flex items-center">
                            ...
                            <ul>
                                {chats.map((chat) => (
                                    <li key={chat.id} className="mb-2">
                                        <Link href={`/marketplace/chat/${chat.id}`} className="text-blue-600 hover:underline">
                                            Chat with {chat.buyerId === userId ? 'Owner' : 'Buyer'} ({chat.id})
                                        </Link>
                                    </li>
                                ))}
                            </ul>
